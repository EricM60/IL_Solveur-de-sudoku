...
/**
 * Interface de grille de sudoku. Chaque case d'une Grille peut contenir un ElementDeGrille 
...
public interface Grille {
     ...
     *  autorisé à cette position dans la grille aux vues des autres valeurs de la grille
     * @throws ElementInterditException            si l'élément de grille n'est pas
     *  autorisé dans cette grille pouvant être mis dans la grille
     * @throws HorsBornesException                 si x ou y sont en dehors de la grille
     * @throws ValeurInitialeModificationException si une valeur initiale de la grille 
     * est en position x,y
     */
     ...
     * @throws ElementInterditException si value n'est pas un caractere pouvant
